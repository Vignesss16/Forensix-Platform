    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <div className="h-1 w-32 bg-secondary rounded-full overflow-hidden mt-1 hidden sm:block">
            <motion.div 
              initial={{ width: 0 }}
              animate={{ width: "35%" }}
        ...
        {rawPhases.map((phaseContent, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative bg-black/40 backdrop-blur-md border border-primary/10 rounded-2xl p-5 hover:border-primary/30 transition-all h-full">
                ...
                <div className="space-y-3">
                  {tasks.length > 0 ? tasks.map((task, tIdx) => {
                      ...
                      <div 
                        ...
                        className={`group/item flex gap-3 p-3 rounded-xl transition-all cursor-pointer border ${
                          isCompleted 
                            ...
                            : 'bg-secondary/20 border-white/5 hover:bg-secondary/30 hover:border-primary/20 shadow-sm'
                        }`}
                    ...
                    <p className="text-[10px] text-muted-foreground italic px-2">No directives identified for this phase.</p>
                  )}
                </div>
              </div>
            </motion.div>
